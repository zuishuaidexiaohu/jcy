...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function (exports) {
        ...
        var that = this
            ...
            , render = function () { //后续性能提升的重点
                ...
                layui.each(data, function (i1, item1) {
                    ...
                    var isLastEdit = options.isLastEdit ? options.isLastEdit : false;
                    var isEdit = false;
                    if (isLastEdit) {
                        if (data.length == (i1 + 1)) {
                            isEdit = true;
    ...
    Class.prototype.events = function () {
        ...
        that.layBody.on('change', '.' + ELEM_EDIT, function () {
            ...
            var updateValue=thisElem.value;
            if(that.config.isLastEdit){
                if (table.cache[that.key].length == (index + 1)) {
                    updateValue= updateValue.match(/（）/g)? updateValue.replace(/（）/g, ""):updateValue;
                }
            }
            ...
            othis.parent().data('content', updateValue);
        ...
        that.layBody.on('click', 'td', function (e) {
            ...
            if (editType) {
                ...
                if (that.config.isLastEdit && input[0].value.search("（")==-1) {
